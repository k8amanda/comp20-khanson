This program uses the Google Maps API as well as MBTA schedule and facilities APIs. When opened, a map opens showing the paths of the MBTA Red, Blue, and Orange lines.
